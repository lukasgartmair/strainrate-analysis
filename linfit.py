...
### author https://github.com/djpine ### 

def linfit(x, y, sigmay=None, relsigma=True, return_all=True):
    """
...
# personal comment Lukas Gartmair
# get the bunch with the error of a and b:
# 1st return_all = True!
